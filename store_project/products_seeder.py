...
with open('products.json') as f:
    data = json.load(f)
for datas in data:
    products = Products(product_type=Categories.objects.get(product_Type_name='Accessories'),product_color=datas['product_color'], product_name=datas['product_name'],product_description=datas['product_description'],
